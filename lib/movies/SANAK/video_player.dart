...
class SANAK extends StatefulWidget {
  const SANAK({super.key});

  @override
  State<SANAK> createState() => _WakandaState();
}

class _WakandaState extends State<SANAK> {
...
void exitFullScreen() async {
 ...
 String dataSource = "https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Single%20Movies%2FSanak%20(2021)%20(NetNaija.com).mp4?alt=media&token=6b83cacd-e859-4345-847d-d6040412c142";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
 ...
 IconButton(
    ...
    Row(
      children: const [
        Text('SANAK  ', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
