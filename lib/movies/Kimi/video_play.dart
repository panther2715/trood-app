...
class Kimi extends StatefulWidget {
  const Kimi({super.key});

  @override
  State<Kimi> createState() => _WakandaState();
}

class _WakandaState extends State<Kimi> {


 String dataSource = "https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Single%20Movies%2FKimi%20(2022)%20(NetNaija.com).mp4?alt=media&token=436cd9c1-b41c-4bce-bf88-3d01096838e6";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
    ...
    Row(
      children: const [
        Text('Kimi ', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
