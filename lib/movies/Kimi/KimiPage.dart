...
import 'package:trood_movie/movies/Kimi/video_play.dart';
...
import 'package:trood_movie/movies/wakanda/wakanda_page.dart';
 ...
 class KimiPage extends StatelessWidget {
   const KimiPage({super.key});
  ...
  Container(
    ...
    decoration: BoxDecoration(
      image: const DecorationImage(
        image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Movie%20Covers%2Fkimi-movie-poster.jpg?alt=media&token=1a2ae81b-c428-4e6f-a9a1-d90c41443974'),
        fit: BoxFit.cover
      ),
    ),
