...
class Grey extends StatefulWidget {
  ...
  @override
  State<Grey> createState() => _WakandaState();
}

class _WakandaState extends State<Grey> {


 String dataSource = "https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Single%20Movies%2FThe%20Gray%20Man%20(2022)%20(NetNaija.com).mp4?alt=media&token=2433ada9-8cbd-4bd9-a1d2-b178bfd01fa4";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
    ...
    Row(
      children: const [
        Text('The Gray Man', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
