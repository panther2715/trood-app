...
class Tomboftheriver extends StatefulWidget {
  const Tomboftheriver({super.key});

  @override
  State<Tomboftheriver> createState() => _WakandaState();
}

class _WakandaState extends State<Tomboftheriver> {


 String dataSource = " https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Single%20Movies%2FTomb%20of%20the%20River%20(2021)%20(NetNaija.com).mp4?alt=media&token=b6536d29-f391-4e3a-9f17-861f2a98e4ec";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
    ...
    Row(
      children: const [
        Text('Tomb Of The River', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
