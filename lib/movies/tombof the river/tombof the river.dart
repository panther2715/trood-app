...
import 'package:trood_movie/movies/wakanda/video_play.dart';
 ...
 class Tomboftheriverpage extends StatelessWidget {
   const Tomboftheriverpage({super.key});
  ...
  Container(
    ...
    decoration: BoxDecoration(
      image: const DecorationImage(
        image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Movie%20Covers%2Ftomb-of-the-river-south-korean-movie-poster.jpg?alt=media&token=1a973b62-b438-4c76-9a7e-ef2c72fc81e5'),
        fit: BoxFit.cover
      ),
    ),
      ...
      child: ElevatedButton(
        ...
        onPressed: (() {
          Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) =>  const Tomboftheriver()));
        }),
         style: ButtonStyle(
       ...
       child: Image.asset('images/alice.jpg') ,
                onTap: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) =>  const Tomboftheriverpage()));
                                },
    ),
