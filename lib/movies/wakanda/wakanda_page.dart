...
import 'package:trood_movie/movies/wakanda/video_play.dart';
 ...
 class WakandaPage extends StatelessWidget {
   const WakandaPage({super.key});
  ...
  Container(
    ...
    decoration: BoxDecoration(
      image: const DecorationImage(
        image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Movie%20Covers%2Fwakanda.jpg?alt=media&token=b5fd6e46-e26b-44d9-89bf-a7b87453e3bb'),
        fit: BoxFit.cover
      ),
    ),
      ...
      child: Card(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: const DecorationImage(
              fit: BoxFit.fill,
              image: AssetImage('images/wakanda.jpg')
            )
          ),
