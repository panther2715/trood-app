...
class Wakanda extends StatefulWidget {
  const Wakanda({super.key});

  @override
  State<Wakanda> createState() => _WakandaState();
}

class _WakandaState extends State<Wakanda> {


 String dataSource = "https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Single%20Movies%2FBlack.Panther.Wakanda.Forever.2022.1080p.HQ.HDTS.English.Msubs.MoviesMod.com.mkv?alt=media&token=d9c2da61-f814-4a60-ac76-7a1853c92b4f";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
    ...
    Row(
      children: const [
        Text('Wakanda Forever', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
