...
class ManFToronto extends StatefulWidget {
  const ManFToronto({super.key});

  @override
  State<ManFToronto> createState() => _WakandaState();
}

class _WakandaState extends State<ManFToronto> {


 String dataSource = "https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Single%20Movies%2FThe%20Man%20From%20Toronto%20(2022)%20(NetNaija.com).mp4?alt=media&token=ae91b806-a951-40d5-9bc0-6ecf5374d430";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
    ...
    Row(
      children: const [
        Text('Man From Toronto', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
