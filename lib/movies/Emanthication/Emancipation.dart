...
import 'package:trood_movie/movies/Emanthication/video_player.dart';
import 'package:trood_movie/movies/wakanda/wakanda_page.dart';
 
 
 

 class EmancipationPage extends StatelessWidget {
   const  EmancipationPage({super.key});
  ...
  Container(
    ...
    decoration: BoxDecoration(
      image: const DecorationImage(
        image: NetworkImage('https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Movie%20Covers%2Fwiliam.jpg?alt=media&token=687053c4-603b-4913-a9af-7ac769e31fd2'),
        fit: BoxFit.cover
      ),
    ),
      ...
      child: ElevatedButton(
        ...
        onPressed: (() {
          Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) =>  const Emancipation()));
        }),
         style: ButtonStyle(
