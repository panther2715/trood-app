...
class Emancipation extends StatefulWidget {
  const Emancipation({super.key});

  @override
  State<Emancipation> createState() => _WakandaState();
}

class _WakandaState extends State<Emancipation> {


 String dataSource = "https://firebasestorage.googleapis.com/v0/b/trood-app.appspot.com/o/Emancipation%20(2022)%20(NetNaija.com).mkv?alt=media&token=7666ba6d-0faa-476a-bca0-ca669a61bafb";
...
VideoProgressIndicator(_controller!, allowScrubbing: true),
    ...
    Row(
      children: const [
        Text('Emancipation Forever', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
      ],
    ),
